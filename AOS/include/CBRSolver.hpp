...
namespace dbt {
  ...
  public:
    CBRSolver(const AOSParams::mlStrategyType::ParamsType &Params,
    ...
    unsigned findSimilar(AOSParams::mlStrategyType::ParamsType::DNATypes, const std::string&, const std::string&);
  };
}
